var bigOak = require('./11_1_crow-tech').bigOak;

var defineRequestType = require('./11_1_crow-tech').defineRequestType;
...
var everywhere = require('./11_1_crow-tech').everywhere;
...
exports.anyStorage = function (nest, source, name) {
